...
export class CreateSchema1765377832189 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "soilhive"."slug_history_entity_type_enum" AS ENUM('datasets', 'licenses', 'soil_property_categories', 'soil_properties', 'unit_conversions', 'analytical_methods')`);
        await queryRunner.query(`CREATE TABLE "soilhive"."slug_history" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "entity_id" uuid NOT NULL, "entity_type" "soilhive"."slug_history_entity_type_enum" NOT NULL, "slug" text NOT NULL, CONSTRAINT "PK_8a081bbe16d88d78868ec734204" PRIMARY KEY ("entity_id", "slug"))`);
        ...
        await queryRunner.query(`CREATE TABLE "soilhive"."observations" ("id" uuid NOT NULL DEFAULT uuidv7(), "dataset_layer_id" uuid NOT NULL, "value" numeric NOT NULL, "analytical_methodology_id" uuid, CONSTRAINT "UQ_cb4760775f415b7835cd7ebbff7" UNIQUE ("dataset_layer_id", "value", "analytical_methodology_id"), CONSTRAINT "PK_f9208d64f50a76030758087c0ef" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."unit_conversions" ADD CONSTRAINT "FK_6b542c70d81b414ac757e6d9f6f" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD CONSTRAINT "FK_46ff570e2bcc8d68b5480fdc65d" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_properties" ADD CONSTRAINT "FK_4aba6fd1c7e9adaa6112a39b140" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soilhive"."datasets" ADD CONSTRAINT "FK_816cc51c1a46eb4c8934bc04b1f" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soilhive"."licenses" ADD CONSTRAINT "FK_ee237df2b602117509506e0a1b7" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."analytical_methods" ADD CONSTRAINT "FK_46a73a6052af10ef649b10a8946" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."files" ADD CONSTRAINT "FK_d6921b298823caf4fd254a8b271" FOREIGN KEY ("id", "slug") REFERENCES "soilhive"."slug_history"("entity_id","slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."dataset_file_mappings" ADD CONSTRAINT "FK_c95cffb2a976245915bf68e3293" FOREIGN KEY ("dataset_id") REFERENCES "soilhive"."datasets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);        await queryRunner.query(`ALTER TABLE "soilhive"."features" SET (
