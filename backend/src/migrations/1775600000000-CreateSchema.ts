...
export class CreateSchema1775600000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "vocabulary" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuidv7(), "slug" text NOT NULL, "category" "vocabulary_category_enum" NOT NULL, "name" text NOT NULL, CONSTRAINT "PK_vocabulary_id_slug" PRIMARY KEY ("id", "slug"))`,
    );
    await queryRunner.query(
