...
export class CreateSchema1765549507801 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "dataset_file_mappings" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuidv7(), "data_mapping_id" uuid, "file_id" uuid, "dataset_id" uuid, CONSTRAINT "UQ_dataset_file_mappings_data_mapping_id_file_id_dataset_id" UNIQUE ("data_mapping_id", "file_id", "dataset_id"), CONSTRAINT "PK_dataset_file_mappings_id" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
