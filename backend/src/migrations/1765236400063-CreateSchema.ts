...
export class CreateSchema1765236400063 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "category_name"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "category_acronym"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "category_name" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "category_acronym" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "property_name" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "property_acronym" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "standard_unit" text`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "property_level" text`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "parent_property_id" uuid`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "category_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD CONSTRAINT "CHK_29e2dc2f6d1c5d73b5172b35b9" CHECK (((property_level >= 1) AND (property_level <= 5)))`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD CONSTRAINT "FK_f2b43d092c861b32fbfe6a42902" FOREIGN KEY ("parent_property_id") REFERENCES "soilhive"."soil_property_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD CONSTRAINT "FK_6de789ebeb16f35676b8237d0bb" FOREIGN KEY ("category_id") REFERENCES "soilhive"."soil_property_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`);
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."dataset_layers" ADD CONSTRAINT "FK_89d62c0f76f226157e341b005cb" FOREIGN KEY ("soil_property_id") REFERENCES "soilhive"."soil_property_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP CONSTRAINT "FK_6de789ebeb16f35676b8237d0bb"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP CONSTRAINT "FK_f2b43d092c861b32fbfe6a42902"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP CONSTRAINT "CHK_29e2dc2f6d1c5d73b5172b35b9"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "category_id"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "parent_property_id"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "property_level"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "standard_unit"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "property_acronym"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "property_name"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "category_acronym"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" DROP COLUMN "category_name"`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "category_acronym" text NOT NULL`);
        await queryRunner.query(`ALTER TABLE "soilhive"."soil_property_categories" ADD "category_name" text NOT NULL`);
