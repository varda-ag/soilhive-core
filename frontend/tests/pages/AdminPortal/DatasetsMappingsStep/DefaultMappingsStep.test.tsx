...
import { DefaultMappingsStep } from '../../../../src/pages/AdminPortal/DatasetsMappingsStep/DefaultMappingsStep';
...
describe('DefaultMappingsStep', () => {
  ...
  it('renders the fields title and subtitle', () => {
    render(<DefaultMappingsStep id="1" />);
  ...
  it('renders the banner as non-raster', () => {
    render(<DefaultMappingsStep id="1" />);
