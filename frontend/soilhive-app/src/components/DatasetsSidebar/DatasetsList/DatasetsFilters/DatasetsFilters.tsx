...
export function DatasetsFilters() {
    ...
    const handleFilterChange = useCallback((value: string | string[], name?: string) => {
        if (!name) return;
    ...
    return (
        <div className={styles.DatasetsFilters}>
            ...
            {isFiltersOpened && <div className={styles.FilterMenu}>
            <div className={styles.FilterHeader}>
                Filters <CrossIcon className={styles.CloseIcon} onClick={() => setIsFiltersOpened(false)}/>
            </div>
                <div className={styles.FilterBody}>
                    <div className={styles.ClearWrapper}>
                        <p className={styles.Clear} role="button" onClick={resetFilters}>Clear</p>
                    </div>
