...
import styles from './DownloadSummarySidebar.module.scss';
...
interface DownloadSummarySidebarProps {
...
// REFACTOR: Duplicate of DownloadPreviewSummary with responsiveness removed.
// Attempted to unify via 'isResponsive' prop, but existing media queries (specifically $bp-desktop)
// require significant CSS restructuring. Temporary duplication allowed to meet current sprint
// deadlines. Plan to consolidate both components once DownloadSummary page is complete.
function DownloadSummarySidebar({
  ...
  return (
    <div className={classNames(styles.DownloadSummarySidebar, { [styles.Expanded]: expanded })}>
...
export default DownloadSummarySidebar;
