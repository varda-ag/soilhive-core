...
import styles from './MapStyleSwitcherMobile.module.scss';
...
export function MapStyleSwitcherMobile({ mapStyles, currentValue, className, onMapStyleChange }: Props) {
  ...
  return (
    <div className={classnames(styles.MapStyleSwitcherMobile, className)}>
