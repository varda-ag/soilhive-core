...
- **Interoperability** — ensuring alignment with international standards so datasets can connect with existing soil databases and workflows.
- **Semantic clarity** — every property is defined unambiguously and interpreted consistently across disciplines.
...
See [Vocabulary Table](../../backend/docs/data-model/4c-soil-property-vocabulary-table.csv) for the full property list.
