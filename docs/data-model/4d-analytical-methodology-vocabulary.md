...
Each entry belongs to one of the following categories, corresponding to the methodology fields described in [Field Mapping](1a-vector-data-ingestion.md#field-mapping--match-your-data):
